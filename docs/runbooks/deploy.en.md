# Runbook — sdkwork-iam deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-iam-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-iam/bundle`, loads the image, starts
