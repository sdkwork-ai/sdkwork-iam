...
/**
 * Route contribution test of `sdkwork_iam_flutter_mobile_admin_account_binding`.
 *
...
import 'package:sdkwork_iam_flutter_mobile_admin_account_binding/sdkwork_iam_flutter_mobile_admin_account_binding.dart';

void main() {
  test('route ids and paths match the cross-client identity', () {
    final Map<String, String> actual = <String, String>{
      for (final RouteContribution contribution in iamFlutterMobileAdminAccountBindingRouteContributions)
