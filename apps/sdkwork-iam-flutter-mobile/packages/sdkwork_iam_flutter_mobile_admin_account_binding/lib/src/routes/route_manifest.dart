...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_admin_account_binding`.
 *
...
final List<RouteContribution> iamFlutterMobileAdminAccountBindingRouteContributions =
    iamFlutterMobileAdminCoreRoutesByCapability('account-binding');

/// Route ids `sdkwork_iam_flutter_mobile_admin_account_binding` owns, in registry order.
List<String> iamFlutterMobileAdminAccountBindingRouteIds() {
  return iamFlutterMobileAdminAccountBindingRouteContributions
