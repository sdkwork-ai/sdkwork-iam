...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_admin_organization`.
 *
...
final List<RouteContribution> iamFlutterMobileAdminOrganizationRouteContributions =
    iamFlutterMobileAdminCoreRoutesByCapability('organization');

/// Route ids `sdkwork_iam_flutter_mobile_admin_organization` owns, in registry order.
List<String> iamFlutterMobileAdminOrganizationRouteIds() {
  return iamFlutterMobileAdminOrganizationRouteContributions
