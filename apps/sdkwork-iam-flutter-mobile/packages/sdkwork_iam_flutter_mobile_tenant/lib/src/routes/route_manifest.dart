...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_tenant`.
 *
...
final List<RouteContribution> iamFlutterMobileTenantRouteContributions =
    iamFlutterMobileCoreRoutesByCapability('tenant');

/// Route ids `sdkwork_iam_flutter_mobile_tenant` owns, in registry order.
List<String> iamFlutterMobileTenantRouteIds() {
  return iamFlutterMobileTenantRouteContributions
