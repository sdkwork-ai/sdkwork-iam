...
/**
 * Package-local locale boundary of `sdkwork_iam_flutter_mobile_user`.
 *
 * Thin by construction (I18N_SPEC.md section 171): the `.arb` fragments under
 * `en-US/iam/user/` and `zh-CN/iam/user/` own the copy, this file
 * only names the locales and the asset path each one is read from.
 */

/// Locales this package ships fragments for.
const List<String> iamFlutterMobileUserSupportedLocales = <String>['en-US', 'zh-CN'];
...
String iamFlutterMobileUserFragmentAssetPath(String locale) =>
    'lib/src/i18n/$locale/iam/user/user.arb';
