...
/**
 * Declared dependency surface of the `app` tier core.
 *
...
/// SDK families the `app` tier consumes.
const List<SdkDependency> iamFlutterMobileCoreSdkDependencies = <SdkDependency>[
  SdkDependency(
