...
/**
 * Generated Dart SDK inventory of the `app` tier.
 *
...
/// SDK clients the `app` tier consumes.
const List<SdkClientDescriptor> iamFlutterMobileCoreSdkClients = <SdkClientDescriptor>[
  SdkClientDescriptor(
