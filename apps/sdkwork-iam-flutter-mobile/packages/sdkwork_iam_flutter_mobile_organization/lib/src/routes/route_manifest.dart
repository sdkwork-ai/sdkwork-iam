...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_organization`.
 *
...
final List<RouteContribution> iamFlutterMobileOrganizationRouteContributions =
    iamFlutterMobileCoreRoutesByCapability('organization');

/// Route ids `sdkwork_iam_flutter_mobile_organization` owns, in registry order.
List<String> iamFlutterMobileOrganizationRouteIds() {
  return iamFlutterMobileOrganizationRouteContributions
