...
/**
 * Package-local locale boundary of `sdkwork_iam_flutter_mobile_auth`.
 *
 * Thin by construction (I18N_SPEC.md section 171): the `.arb` fragments under
 * `en-US/iam/auth/` and `zh-CN/iam/auth/` own the copy, this file
 * only names the locales and the asset path each one is read from.
 */

/// Locales this package ships fragments for.
const List<String> iamFlutterMobileAuthSupportedLocales = <String>['en-US', 'zh-CN'];
...
String iamFlutterMobileAuthFragmentAssetPath(String locale) =>
    'lib/src/i18n/$locale/iam/auth/auth.arb';
