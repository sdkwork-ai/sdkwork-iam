...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_console_cloud_account`.
 *
...
final List<RouteContribution> iamFlutterMobileConsoleCloudAccountRouteContributions =
    iamFlutterMobileConsoleCoreRoutesByCapability('cloud-account');

/// Route ids `sdkwork_iam_flutter_mobile_console_cloud_account` owns, in registry order.
List<String> iamFlutterMobileConsoleCloudAccountRouteIds() {
  return iamFlutterMobileConsoleCloudAccountRouteContributions
