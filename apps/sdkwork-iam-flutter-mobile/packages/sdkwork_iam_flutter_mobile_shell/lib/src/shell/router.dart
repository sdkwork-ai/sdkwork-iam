...
/**
 * Navigation assembly of the `app` tier.
 *
...
/// One named route of the `app` tier.
...
/// Builds the named-route table of the `app` tier.
Map<String, WidgetBuilder> buildIamFlutterMobileCoreRouteTable(List<SdkworkRouteEntry> entries) {
...
String? resolveIamFlutterMobileCoreRouteId(List<SdkworkRouteEntry> entries, String path) {
