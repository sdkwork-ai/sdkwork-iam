...
/**
 * Shell assembly of the `app` tier.
 *
...
/// Root widget of the `app` tier.
class IamFlutterMobileCoreShell extends StatelessWidget {
  const IamFlutterMobileCoreShell({
    super.key,
    required this.title,
    required this.home,
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: buildIamFlutterMobileCoreRouteTable(routeEntries),
      home: home,
    );
  }
}
