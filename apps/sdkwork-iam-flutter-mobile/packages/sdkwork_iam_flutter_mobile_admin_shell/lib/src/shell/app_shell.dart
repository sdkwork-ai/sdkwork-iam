...
/**
 * Shell assembly of the `admin` tier.
 *
...
/// Root widget of the `admin` tier.
class IamFlutterMobileAdminCoreShell extends StatelessWidget {
  const IamFlutterMobileAdminCoreShell({
    super.key,
    required this.title,
    required this.home,
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: buildIamFlutterMobileAdminCoreRouteTable(routeEntries),
      home: home,
    );
  }
}
