...
/**
 * Composition entry of the `console` tier (section 3, APP_COMPOSITION_SPEC.md).
 *
...
const String iamFlutterMobileConsoleCoreComponentSpecPath = '../../../../specs/component.spec.json';
