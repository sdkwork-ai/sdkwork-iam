...
/**
 * Host adapter registry of the `console` tier.
 *
...
/// Registry of the platform adapters available to the `console` tier.
class IamFlutterMobileConsoleCoreHostRegistry {
  IamFlutterMobileConsoleCoreHostRegistry(List<SdkworkHostAdapter> adapters)
