...
/**
 * Session and context store of the `console` tier.
 *
...
class IamFlutterMobileConsoleCoreSessionContext {
  const IamFlutterMobileConsoleCoreSessionContext({
    this.userId,
    this.tenantId,
    this.organizationId,
    this.accessToken,
...
/// In-memory context store of the `console` tier.
class IamFlutterMobileConsoleCoreContextStore {
  IamFlutterMobileConsoleCoreSessionContext? _context;

  /// Current context, or null when signed out.
  IamFlutterMobileConsoleCoreSessionContext? get current => _context;

  /// Replaces the current context.
  void set(IamFlutterMobileConsoleCoreSessionContext context) {
    _context = context;
  }
