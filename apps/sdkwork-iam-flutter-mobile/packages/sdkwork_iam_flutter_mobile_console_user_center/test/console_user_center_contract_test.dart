...
/**
 * Route contribution test of `sdkwork_iam_flutter_mobile_console_user_center`.
 *
...
import 'package:sdkwork_iam_flutter_mobile_console_user_center/sdkwork_iam_flutter_mobile_console_user_center.dart';

void main() {
  test('route ids and paths match the cross-client identity', () {
    final Map<String, String> actual = <String, String>{
      for (final RouteContribution contribution in iamFlutterMobileConsoleUserCenterRouteContributions)
