...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_admin_tenant`.
 *
...
final List<RouteContribution> iamFlutterMobileAdminTenantRouteContributions =
    iamFlutterMobileAdminCoreRoutesByCapability('tenant');

/// Route ids `sdkwork_iam_flutter_mobile_admin_tenant` owns, in registry order.
List<String> iamFlutterMobileAdminTenantRouteIds() {
  return iamFlutterMobileAdminTenantRouteContributions
