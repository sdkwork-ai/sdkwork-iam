...
/**
 * Package-local locale boundary of `sdkwork_iam_flutter_mobile_admin_oauth`.
 *
 * Thin by construction (I18N_SPEC.md section 171): the `.arb` fragments under
 * `en-US/iam/admin_oauth/` and `zh-CN/iam/admin_oauth/` own the copy, this file
 * only names the locales and the asset path each one is read from.
 */

/// Locales this package ships fragments for.
const List<String> iamFlutterMobileAdminOauthSupportedLocales = <String>['en-US', 'zh-CN'];
...
String iamFlutterMobileAdminOauthFragmentAssetPath(String locale) =>
    'lib/src/i18n/$locale/iam/admin_oauth/admin_oauth.arb';
