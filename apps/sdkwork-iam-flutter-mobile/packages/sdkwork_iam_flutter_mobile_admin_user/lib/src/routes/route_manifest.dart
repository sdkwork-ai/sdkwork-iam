...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_admin_user`.
 *
...
final List<RouteContribution> iamFlutterMobileAdminUserRouteContributions =
    iamFlutterMobileAdminCoreRoutesByCapability('user');

/// Route ids `sdkwork_iam_flutter_mobile_admin_user` owns, in registry order.
List<String> iamFlutterMobileAdminUserRouteIds() {
  return iamFlutterMobileAdminUserRouteContributions
