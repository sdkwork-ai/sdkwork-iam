...
/**
 * Immutable presentation state of `sdkwork_iam_flutter_mobile_admin_user`.
 *
...
/// State of the `admin_user` capability.
class IamFlutterMobileAdminUserState {
  const IamFlutterMobileAdminUserState({
    this.loading = false,
    this.errorKey,
  ...
  IamFlutterMobileAdminUserState copyWith({
    bool? loading,
    String? errorKey,
    List<String>? items,
  }) {
    return IamFlutterMobileAdminUserState(
