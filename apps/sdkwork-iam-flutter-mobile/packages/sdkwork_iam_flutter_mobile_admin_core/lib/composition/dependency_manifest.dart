...
/**
 * Declared dependency surface of the `admin` tier core.
 *
...
/// SDK families the `admin` tier consumes.
const List<SdkDependency> iamFlutterMobileAdminCoreSdkDependencies = <SdkDependency>[
  SdkDependency(
