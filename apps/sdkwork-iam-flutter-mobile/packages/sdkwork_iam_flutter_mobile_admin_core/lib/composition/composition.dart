...
/**
 * Composition entry of the `admin` tier (section 3, APP_COMPOSITION_SPEC.md).
 *
...
const String iamFlutterMobileAdminCoreComponentSpecPath = '../../../../specs/component.spec.json';
