...
/**
 * Host adapter registry of the `admin` tier.
 *
...
/// Registry of the platform adapters available to the `admin` tier.
class IamFlutterMobileAdminCoreHostRegistry {
  IamFlutterMobileAdminCoreHostRegistry(List<SdkworkHostAdapter> adapters)
