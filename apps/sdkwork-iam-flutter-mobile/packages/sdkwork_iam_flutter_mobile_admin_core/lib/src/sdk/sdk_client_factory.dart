...
/**
 * SDK factory contract of the `admin` tier (section 3: the core owns SDK
...
abstract class IamFlutterMobileAdminCoreSdkClientFactory<TClient> {
  ...
  String get clientClass => 'SdkworkBackendClient';
}
