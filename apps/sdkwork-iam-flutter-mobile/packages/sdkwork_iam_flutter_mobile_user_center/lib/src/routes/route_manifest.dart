...
/**
 * Route manifest of `sdkwork_iam_flutter_mobile_user_center`.
 *
...
final List<RouteContribution> iamFlutterMobileUserCenterRouteContributions =
    iamFlutterMobileCoreRoutesByCapability('user-center');

/// Route ids `sdkwork_iam_flutter_mobile_user_center` owns, in registry order.
List<String> iamFlutterMobileUserCenterRouteIds() {
  return iamFlutterMobileUserCenterRouteContributions
